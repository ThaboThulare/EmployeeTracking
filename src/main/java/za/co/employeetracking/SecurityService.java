...
import static za.co.employeetracking.mapper.Mapper.toUserQueryModel;
import za.co.employeetracking.model.UserQueryModel;
import za.co.employeetracking.repository.UserRepository;
...
public class SecurityService {
    ...
    public ResponseEntity<String> login(@RequestParam(value = "state", required = false, defaultValue = "/") String state) {
        ...
        headers.add("Location", "attendance/signin.html");
    ...
    @RequestMapping(value = "/attendance/login", method = RequestMethod.POST)
